...
//V_1 = V_TAXI = ASC_TAXI + B_VIS * VISITOR + B_BIZ * BUSINESS + B_INC * LOWINC + B_COST * GC_TAXI
//V_2 = V_TRANSIT = ASC_TRANSIT + B_VIS * VISITOR + B_BIZ * BUSINESS + B_INC * LOWINC + B_COST * GC_TRANSIT
